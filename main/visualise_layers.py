...
class CNNLayerVisualization():
    ...
    """
    def __init__(self, model, selected_layer, selected_filter, data_iter):
        self.model = model
        self.model.eval()
    ...
    def visualise_layer_without_hooks(self):
        # Process image and return variable
        self.processed_image = Variable(self.created_image.cuda(), requires_grad=True)
...
if __name__ == '__main__':
    ...
    layer_vis = CNNLayerVisualization(net.cnn1, cnn_layer, filter_pos, data_iter)
